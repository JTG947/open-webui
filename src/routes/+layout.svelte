				...
				if (done) {
					...
					if ($isLastActiveTab) {
						if ($settings?.notificationEnabled ?? false) {
							new Notification(`${displayTitle} • Aegis`, {
								body: content,
								icon: `${WEBUI_BASE_URL}/static/aethyron.svg`
							});
						}
					}
...
<svelte:head>
	...
	<link crossorigin="anonymous" rel="icon" href="{WEBUI_BASE_URL}/static/aethyron.svg" />
