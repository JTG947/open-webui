...
- **Simplified Ollama Settings**: Ollama settings now don't require the `/api` suffix. You can now utilize the Ollama base URL directly, e.g., `http://127.0.0.1:8000/v1`. Also, an `OLLAMA_BASE_URL` environment variable has been added.
